...
export class DishonoredCharacterSheet extends ActorSheet {
    ...
    get template () {
        ...
        if (!game.user.isGM && this.actor.limited) return "systems/dishonored/templates/actors/limited-sheet.html";
        return "systems/dishonored/templates/actors/character-sheet.html";
    }
    ...
    getData() {
        ...
        $.each(sheetData.items, (key, item) => {
            if (item.img == "icons/svg/item-bag.svg") item.img = "/systems/dishonored/icons/dishonoredDefaultLogo.webp";
            if (item.img == "icons/svg/mystery-man.svg") item.img = "/systems/dishonored/icons/dishonoredDefaultLogo.webp";
        });
    ...
    activateListeners(html) {
        ...
        let expPointsMax = game.settings.get("dishonored", "maxNumberOfExperience");
        ...
        html.find(".check-button").click(ev => {
            ...
            let focusList = this.actor.items.filter(function (item) { return item.type == "focus"});
